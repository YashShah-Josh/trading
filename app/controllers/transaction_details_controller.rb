class TransactionDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transaction_detail.save
        format.html { redirect_to @transaction_detail, notice: "Transaction detail was successfully created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to transaction_details_path, status: :see_other, notice: "Transaction detail was successfully destroyed." }
  ...
  private
    ...
    def transaction_detail_params
      params.fetch(:transaction_detail, {})
    end
end
